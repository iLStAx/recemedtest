defmodule RecemedtestWeb.UserAuthTest do
  use RecemedtestWeb.ConnCase, async: true

  alias Recemedtest.Accounts
  alias Recemedtest.Accounts.Scope
  alias RecemedtestWeb.UserAuth

  import Recemedtest.AccountsFixtures

  @remember_me_cookie "_recemedtest_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, RecemedtestWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
